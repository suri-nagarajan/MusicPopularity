...
#show_pages(
#    [
#        Page("Music_project.py", "Home", "🏠"),
#        Page("pages/1_genre_plots.py", "Music Genre Analysis", ":books:"),
#        Page("pages/2_artist_plots.py", "Music Artists Analysis", ":books:"),
#        Page("pages/3_Get_Spotify_song_features.py", "Real time song popularity prediction", ":books:")
#    ]
#)
